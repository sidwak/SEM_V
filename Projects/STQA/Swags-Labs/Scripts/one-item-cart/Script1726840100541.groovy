...
WebUI.setText(findTestObject('Object Repository/Page_Swag Labs/input_Swag Labs_user-name'), 'standard_us')
...
WebUI.verifyElementPresent(findTestObject('Page_Swag Labs/button_Add to cart'), 5, FailureHandling.STOP_ON_FAILURE)
