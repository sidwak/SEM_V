  ...
  return (
    <div className="w-[440px] overflow-hidden bg-white rounded-lg shadow-lg dark:bg-slate-800">
      ...
      <div className="flex items-center justify-between px-4 py-4 bg-slate-800">
        ...
        <button className="px-2 py-1 text-md font-semibold text-white transition-all duration-100 transform bg-blue-500 rounded hover:bg-blue-700 hover:scale-110">
          Book
        </button>
      </div>
    </div>
